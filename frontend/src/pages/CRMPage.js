...
import { formatCurrency, formatDate, PIPELINE_STAGES, maskCurrency, parseCurrencyInput, formatCurrencyInput } from "../lib/utils";
  ...
  const openModal = (lead = null) => {
    if (lead) {
      ...
      setFormData({
        ...
        stage: lead.stage,
        contract_value: formatCurrencyInput(lead.contract_value),
